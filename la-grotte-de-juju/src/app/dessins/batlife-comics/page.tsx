      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <p className="text-muted-foreground md:text-xl max-w-[800px] mb-8">
            Plongez dans l'univers déjanté de Batlife, une série de bandes dessinées originales
            créées par La Grotte de Juju. Suivez les aventures de notre chauve-souris préférée et
            de ses amis hauts en couleur.
          </p>
